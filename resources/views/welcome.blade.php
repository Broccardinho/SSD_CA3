...
{{--                START BUILDING--}}
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8" id="featured-pokemon">
            ...
            <div class="text-center py-8">
                <p class="text-gray-600 text-sm">Loading Pokémon...</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-6 mb-8">
        <div class="bg-gray-200 p-4 rounded-lg border-4 border-gray-400">
            ...
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/6.png" alt="Charizard" class="w-full rounded border-2 border-gray-400">
        </div>

        <div class="bg-gray-200 p-4 rounded-lg border-4 border-gray-400">
            <div class="bg-gray-300 p-2 mb-3 rounded border-2 border-gray-500">
                <h3 class="text-red-600 text-sm md:text-base mb-2">TYPE ANALYSIS</h3>
                <p class="text-gray-700 text-xs">Real-time type coverage using PokéAPI's comprehensive type data.</p>
            </div>
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/9.png" alt="Blastoise" class="w-full rounded border-2 border-gray-400">
        </div>

        <div class="bg-gray-200 p-4 rounded-lg border-4 border-gray-400">
            <div class="bg-gray-300 p-2 mb-3 rounded border-2 border-gray-500">
                <h3 class="text-red-600 text-sm md:text-base mb-2">POKÉDEX</h3>
                <p class="text-gray-700 text-xs">Browse all 151 Pokémon with data pulled directly from PokéAPI.</p>
            </div>
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/3.png" alt="Venusaur" class="w-full rounded border-2 border-gray-400">
        </div>
    </div>
    ...
    <div class="bg-yellow-100 rounded-lg border-4 border-yellow-300 p-6">
        ...
        <div class="grid md:grid-cols-3 gap-4" id="recent-teams">
            <!-- This will be populated by JavaScript -->
            <div class="text-center py-8">
                <p class="text-gray-600 text-sm">Loading recent teams...</p>
            </div>
        </div>
    </div>
</main>
